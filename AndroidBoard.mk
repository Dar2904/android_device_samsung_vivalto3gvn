...
$(shell cp $(ANDROID_BUILD_TOP)/device/samsung/vivalto3gvn/prop/rule_bison.py $(ANDROID_BUILD_TOP)/external/chromium_org/third_party/WebKit/Source/core/scripts)
...
$(shell cat /dev/null | tee '$(ANDROID_BUILD_TOP)/packages/apps/OmniGears/src/org/omnirom/omnigears/BarsAndMenusSettings.java' '$(ANDROID_BUILD_TOP)/packages/apps/OmniGears/src/org/omnirom/omnigears/ButtonSettings.java')
